					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li><a href="contact.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Manage Contact</span><div class="clearfix"></div></a></li>
									<li><a href="gallery.php"><i class="fa fa-file-text-o" aria-hidden="true"></i>  <span>Manage Gallery</span><div class="clearfix"></div></a></li>
